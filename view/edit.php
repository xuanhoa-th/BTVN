...
<div class="container-fluid">
    ...
    <div class="col-md-10">
        <form class="navbar-form navbar-left" role="search" method="post"
              action="../action/update.php?index=<?php echo $index ?>" enctype="multipart/form-data">
            ...
            <input type="file" class="form-control" name="file" value="<?php echo $student->getImage()?>">
            <br>
            <br>
        ...
        <?php else:?>
        <p>du lieu hoc vien khong ton tai</p>
    <?php endif; ?>
</div>
</body>
</html>